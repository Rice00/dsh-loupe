...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    .loupe-hist-sel{font-weight:600;color:var(--dsw-alias-label-secondary,#4b5566);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
    .loupe-hist-q{font-size:13.5px;margin-top:3px;color:var(--dsw-alias-label-primary,#1b1f27);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
